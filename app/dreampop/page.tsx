...
// Add GameTimer component
function GameTimer({ timeLeft, totalTime }: { timeLeft: number, totalTime: number }) {
  ...
  return (
    <div className="fixed top-4 left-4 z-20 w-40">
      <div className="bg-black/80 backdrop-blur-sm border border-zinc-800 rounded-full p-1.5">
        <div className="flex items-center mb-1 px-2">
          <span className="text-xs font-medium">Time Remaining</span>
          <span className="ml-auto text-xs font-bold">{Math.ceil(timeLeft)}s</span>
        </div>
